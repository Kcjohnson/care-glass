#################################
# Push sequenza seg + params for GLSS-LX-WGS into db
# Updated: 2023.03.20
...
## Limit to new cohorts (GLSS-LX)
df_new <- df_new[grep("GLSS-LX", df_new[,"pair_barcode"]),]
...
dat <- read.delim("results/sequenza/glss_lx_batch2_seqz_params.txt")
