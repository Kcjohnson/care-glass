...
## Parse snakemake. Change folder depending on cohort (e.g, CARE-MD/CARE-PT/CARE-PS/CARE-TK/CARE-TO).
maff = "results/mutect2/consensusvcf/CARE-TO/consensus.normalized.sorted.vep.maf"
vcff = "results/mutect2/consensusvcf/CARE-TO/consensus.normalized.sorted.vcf.gz"
tsvf = "results/mutect2/maf2db/CARE-TO/consensus.normalized.sorted.vep.tsv"
dir.create("results/mutect2/maf2db/CARE-TO")
