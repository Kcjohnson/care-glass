...
library(VariantAnnotation) # I believe this is only needed for the readVcf function (make sure conda environment has this).
library(ensemblVEP)
library(tidyverse)
library(DBI)
library(odbc)
...
## Parse snakemake. Change folder depending on cohort (e.g, CARE-MD/CARE-PT/CARE-PS/CARE-TK/CARE-TO/GLSS-LX).
maff = "results/mutect2/consensusvcf/GLSS-LX-batch2/consensus.normalized.sorted.vep.maf"
vcff = "results/mutect2/consensusvcf/GLSS-LX-batch2/consensus.normalized.sorted.vcf.gz"
tsvf = "results/mutect2/maf2db/GLSS-LX-batch2/consensus.normalized.sorted.vep.tsv"
dir.create("results/mutect2/maf2db/GLSS-LX-batch2")
