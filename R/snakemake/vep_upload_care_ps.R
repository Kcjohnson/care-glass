...
maff = "results/mutect2/consensusvcf/CARE-PS/consensus.normalized.sorted.vep.maf"
vcff = "results/mutect2/consensusvcf/CARE-PS/consensus.normalized.sorted.vcf.gz"
tsvf = "results/mutect2/maf2db/CARE-PS/consensus.normalized.sorted.vep.tsv"
