...
maff = "results/mutect2/consensusvcf/CARE-TK/consensus.normalized.sorted.vep.maf"
vcff = "results/mutect2/consensusvcf/CARE-TK/consensus.normalized.sorted.vcf.gz"
tsvf = "results/mutect2/maf2db/CARE-TK/consensus.normalized.sorted.vep.tsv"
dir.create("results/mutect2/maf2db/CARE-TK")
