...
maff = "results/mutect2/consensusvcf/CARE-PT/consensus.normalized.sorted.vep.maf"
vcff = "results/mutect2/consensusvcf/CARE-PT/consensus.normalized.sorted.vcf.gz"
tsvf = "results/mutect2/maf2db/CARE-PT/consensus.normalized.sorted.vep.tsv"
