...
myinf1 <- myinf1[grep("GLSS-LX",myinf1)]

myoutf1 <- myinf1
myoutf1 <- gsub(".tsv","",myoutf1)
myinf1 <- paste(myDir1,myinf1,sep="")

myTarDir <-"/projects/verhaak-lab/USERS/johnsk/glass4/shell/glss_lx_new_info_db_upload/"
...
myTarDir <-"/projects/verhaak-lab/USERS/johnsk/glass4/shell/glss_lx_new_geno_db_upload/"
myoutf1 <- paste(myTarDir, myoutf1,".sp",sep="")
