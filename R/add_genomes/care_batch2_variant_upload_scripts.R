...
# Remove CARE-TK-TK06.info.tsv and revisit later since it does not have a matched normal
myinf1 <- myinf1[-grep("CARE-TK-TK06",myinf1)]
myoutf1 <- myinf1
myoutf1 <- gsub(".tsv","",myoutf1)
myinf1 <- paste(myDir1,myinf1,sep="")

myTarDir <-"/projects/verhaak-lab/USERS/johnsk/glass4/shell/care_batch2_new_info_db_upload/"
...
myTarDir <-"/projects/verhaak-lab/USERS/johnsk/glass4/shell/care_batch2_new_geno_db_upload/"
myoutf1 <- paste(myTarDir, myoutf1,".sp",sep="")
