...
# Make sure appropriate sample number are uploaded.
outfn <- "results/align/GLSS-LX_wgsmetrics.merged.tsv"
...
dbWriteTable(con, Id(schema="analysis", table="coverage"), glass_samples_cumulative_cov, append=TRUE)
